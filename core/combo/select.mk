...
$(combo_var_prefix)GLOBAL_CFLAGS := $(SELECT_FILE_FLAGS) -fno-exceptions -Wno-multichar
$(combo_var_prefix)RELEASE_CFLAGS := $(SELECT_FILE_FLAGS)
$(combo_var_prefix)GLOBAL_CPPFLAGS := $(SELECT_FILE_FLAGS)
